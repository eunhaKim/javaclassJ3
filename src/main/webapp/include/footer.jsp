      ...
      <div class="row">
        <div class="col-md-4 mb-5">
          ...
          <div class="d-flex flex-column justify-content-start">
            ...
            <a class="text-secondary mb-2" href="https://github.com/eunhaKim/" target="_blank"><i class="fa fa-angle-right mr-2"></i>Github</a>
            <a class="text-secondary mb-2" href="https://www.notion.so" target="_blank"><i class="fa fa-angle-right mr-2"></i>Notion</a>
