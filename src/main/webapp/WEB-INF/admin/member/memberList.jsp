	    ...
	    <div class="row px-xl-5">
	        <div class="col-12">
	            <nav class="breadcrumb bg-light">
	                ...
	                <a class="breadcrumb-item text-dark" href="#">회원관리</a>
	                <a href="MemberList.ad" class="breadcrumb-item text-primary">회원리스트</a>
	            </nav>
	        </div>
	    </div>
	</div>
    ...
    <div class="row px-xl-5">
      <div class="col-lg-12 mb-5">
        <div class="bg-light p-30">
				  ...
				  <hr/>
				  <div id="totalList">
					  <h3 class="text-center my-5">전체 회원 리스트</h3>
					  <div class="row">
				  ...
				  <br/>
					...
					<div class="text-center">
					  <ul class="pagination justify-content-center">
					    <c:if test="${pag > 1}"><li class="page-item"><a class="page-link text-dark" href="${ctp}/MemberList.ad?pag=1&pageSize=${pageSize}">첫페이지</a></li></c:if>
					  	<c:if test="${curBlock > 0}"><li class="page-item"><a class="page-link text-dark" href="${ctp}/MemberList.ad?pag=${(curBlock-1)*blockSize+1}&pageSize=${pageSize}">이전블록</a></li></c:if>
					  	<c:forEach var="i" begin="${(curBlock*blockSize)+1}" end="${(curBlock*blockSize)+blockSize}" varStatus="st">
						    <c:if test="${i <= totPage && i == pag}"><li class="page-item active"><a class="page-link text-dark bg-primary border-secondary" href="${ctp}/MemberList.ad?pag=${i}&pageSize=${pageSize}">${i}</a></li></c:if>
						    <c:if test="${i <= totPage && i != pag}"><li class="page-item"><a class="page-link text-dark" href="${ctp}/MemberList.ad?pag=${i}&pageSize=${pageSize}">${i}</a></li></c:if>
					  	</c:forEach>
					  	<c:if test="${curBlock < lastBlock}"><li class="page-item"><a class="page-link text-dark" href="${ctp}/MemberList.ad?pag=${(curBlock+1)*blockSize+1}&pageSize=${pageSize}">다음블록</a></li></c:if>
					  	<c:if test="${pag < totPage}"><li class="page-item"><a class="page-link text-dark" href="${ctp}/MemberList.ad?pag=${totPage}&pageSize=${pageSize}">마지막페이지</a></li></c:if>
					  </ul>
					</div>
					<!-- 블록페이지 끝 -->
				</div>
